...
const OneDayOutingRequestModal = ({ open, onClose }) => {
  ...
  const fetchRequests = async (admissionNumber) => {
    try {
      ...
      const res = await axios.get(
        `https://fredbox-backend.onrender.com/outing/student/${admissionNumber}`
      );
      if (res.data.success) {
  ...
  const fetchMonthlyCount = async (admissionNumber) => {
    const now = new Date();
    const res = await axios.get("https://fredbox-backend.onrender.com/outing/count", {
      params: {
        admissionNumber,
        month: now.getMonth(),
  ...
  const fetchEligibility = async (admissionNumber) => {
    try {
      ...
      const res = await axios.get(
        "https://fredbox-backend.onrender.com/admin/outing/eligible"
      );
  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await axios.post(
        "https://fredbox-backend.onrender.com/outing/request",
        formData
      );
