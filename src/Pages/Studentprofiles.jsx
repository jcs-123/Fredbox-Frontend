                ...
                <div className="student-info-preview">
                  <div className="preview-avatar">
                    {showDeleteConfirm.profilePhoto ? (
                      <img 
                        src={`https://fredbox-backend.onrender.com/uploads/students/profile/${showDeleteConfirm.profilePhoto}`}
                    ...
                    <div className="card-header-mobile">
                      <div className="student-avatar-mobile">
                        {student.profilePhoto ? (
                          <img
                            src={`https://fredbox-backend.onrender.com/uploads/students/profile/${student.profilePhoto}?t=${new Date().getTime()}`}
                            alt={student.name}
